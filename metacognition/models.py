...
class ReasoningStep(models.Model):
    ...
    max_new_tokens = models.IntegerField(default=1500, help_text="Maximum tokens to generate for this step. Increase for long-form analysis, decrease for short routing decisions.")
